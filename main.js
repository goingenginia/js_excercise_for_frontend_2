 ...
 */
const midashi = document.getElementById("title");
midashi.textContent = "JSで変更した後のタイトル";
 ...
 */
const neko = document.getElementById("profile")
neko.setAttribute("src", "https://www.pakutaso.com/shared/img/thumb/TOMnemuiDSC01757_TP_V1.jpg");
